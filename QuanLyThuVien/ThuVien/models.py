...
class ChiTietPhieuMuon(models.Model):
    ...
    sach = models.ForeignKey(Sach, on_delete=models.SET_NULL, null=True, related_name="chi_tiet_phieu_muon")
    ...
    def __str__(self):
        return f"{self.sach.tenSach} - {self.phieuMuon.docGia.username}"
...
# Interaction (base model for comment, like, share)
